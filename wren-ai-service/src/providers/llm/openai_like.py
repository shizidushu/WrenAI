...
EMBED_OPENAI_API_BASE = "https://api.openai.com/v1"
...
class AsyncGenerator(OpenAIGenerator):
    ...
    async def run(
        ...
        # print("openai_formatted_messages", openai_formatted_messages)
        generation_kwargs = {}
...
class OpenAILikeLLMProvider(LLMProvider):
    def __init__(
        ...
        embed_api_key: Secret = Secret.from_env_var("EMBED_OPENAI_API_KEY"),
        embed_api_base: str = os.getenv("EMBED_OPENAI_API_BASE") or EMBED_OPENAI_API_BASE,
